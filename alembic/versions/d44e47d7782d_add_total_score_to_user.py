...
Revision ID: d44e47d7782d
Revises: 
Create Date: 2025-07-05 21:35:16.866004
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('total_score', sa.Float(), nullable=True))
