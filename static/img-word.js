document.addEventListener('DOMContentLoaded', () => {
            ...
            async function loadQuestion(id) {
                const url = id ? `/image-word/${id}/` : `/image-word/start/${encodeURIComponent(currentCategory)}`;
                try {
            ...
            async function evaluateAnswer() {
                ...
                try {
                    ...
                    showFeedbackMessage(result.correct ? "Correct! Well done!" : "Incorrect. Let's try the next one.", result.correct);
